...
const Landing = () => {
    return ( 
      <div className="bg-white">
        ...
        <br /><br />
        Away from the desk, I am reading a book or playing games such as Football Manager, God of War and FIFA. I am also a food lover that hikes, powerlift and plays footie on the side</p>
      ...
      <a href='\nathan_parchment_CV.pdf' target="_blank" rel="noopener noreferrer"><TbFileCv />View Resume</a>
      </div>
