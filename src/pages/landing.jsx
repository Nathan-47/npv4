...
const Landing = () => {
    return ( 
      ...
      {/* history section */}
      {/* TODO: Add experience heading here */}
      <div className='grid grid-cols-3 gap-4 text-gray-300' id="job-text">
        <div className='job-desc'>2021 - PRESENT</div>
         <div className="col-span-2">
          ...
          <br />
          <p className='job-desc'>Working with Graphics/UI Designer to Develop and design more accessible, informative and smoother navigation to students at Birmingham City University.</p>
          </div>
         ...
         <div className="col-span-2">
          ...
          <br />
          <p className='job-desc'>Using tools such as Skilltide and Lighthouse to help increase WCAG accessibility scores across the website.</p>
          </div>
      </div>
